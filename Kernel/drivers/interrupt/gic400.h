...
#define GIC_400_GICD_IIDR_OFFSET \
  0x008  // Distributor Implementer Identification Register, GICD_IIDR
...
#define GIC_400_GICD_ICENABLERn_OFFSET \
...
#define GIC_400_GICD_GICD_ICPENDRn_OFFSET \
...
#define GIC_400_GICD_ICACTIVERn_OFFSET \
...
#define GIC_400_GICD_ITARGETSRn_OFFSET \
...
#define GIC_400_GICD_PPISR_OFFSET \
  0xD00  // Private Peripheral Interrupt Status Register
#define GIC_400_GICD_GICD_SPISRn_OFFSET \
  0xD04  // Shared Peripheral Interrupt Status Registers
